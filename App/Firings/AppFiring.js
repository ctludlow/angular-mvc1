var firingModule = angular.module('firing', ['common'])
    .config(function ($routeProvider, $locationProvider) {

        $routeProvider.when('/firings', { templateUrl: '/App/Firings/Views/Firings.html', controller: 'firingsViewModel' });
        $routeProvider.when('/firings/show/:firingId', { templateUrl: '/App/Firings/Views/Firing.html', controller: 'firingViewModel' });
        $routeProvider.otherwise({ redirectTo: '/firings' });
        $locationProvider.
